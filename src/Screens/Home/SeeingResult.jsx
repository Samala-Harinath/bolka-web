...
const SeeingResult = () => {
    return (
        <div className='flex flex-col justify-center items-center gap-5'>
            <h1 className='font-syne font-bold md:text-4xl text-2xl text-center text-[#1F2229] mb-6'>Start Seeing Results Today</h1>
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-5 w-full flex-1'>
                ...
                <div className='flex flex-col space-y-5 flex-1 md:col-span-2 lg:col-span-1'>
                    <Image  src={RobotHand} alt='RobotHand' className='object-civer w-full h-full'/>
                </div>
            </div>
        </div>
    )
