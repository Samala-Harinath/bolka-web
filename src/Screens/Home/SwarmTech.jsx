...
const SwarmTech = () => {
    ...
    const handleBolkaSwarmSection = () => {
        ...
        trackEvent({ category: 'Home-BolkaSwarm', action: 'click-event', href: 'https://app.bolka.ai/sign-up', name: 'Try Bolka to see the difference', });
    }
    return (
        <div className=' w-full'>
            <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-full flex-1 '>
                <div className='shadow-[inset_0_-5px_20px_rgba(234,172,95,0.5)] p-8 rounded-[50px] flex flex-col  font-syne text-[#181D27] text-[22px] flex-1 justify-center gap-4'>
                    <h2 className='text-[22px]'>Up to</h2>
                    <h3 className='lg:text-[50px] md:text-3xl leading-none text-[#E48B1E] font-krona'>90%  <span className='font-syne font-bold'>Reduction</span></h3>
                    <p>in operational costs</p>
                </div>
                <div className='shadow-[inset_0_-5px_20px_rgba(234,172,95,0.5)] p-8 rounded-[50px] flex flex-col  font-syne text-[#181D27] text-[22px] flex-1 justify-center gap-4'>
                    <h2 className='text-[22px]'>Up to</h2>
                    <h3 className='lg:text-[50px] md:text-3xl leading-none text-[#E48B1E] font-krona'>3x  <span className='font-syne font-bold'>Faster Outreach</span></h3>
                    <p>in minutes, not hours</p>
                </div>
                <div className='shadow-[inset_0_-5px_20px_rgba(234,172,95,0.5)] p-8 rounded-[50px] flex flex-col  font-syne text-[#181D27] text-[22px] flex-1 justify-center gap-4 '>
                    <h2 className='text-[22px]'>Up to</h2>
                    <h3 className='lg:text-[50px] md:text-3xl leading-none text-[#E48B1E] font-krona'>50% <span className='font-syne font-bold'>Increase</span></h3>
                    <p>in Conversion Rates</p>
                </div>
            </div>

            <div className=' flex max-md:flex-col  gap-5 mt-24'>
                ...
                <div className='flex md:min-w-[37%] relative max-md:flex-col   '>
                    ...
                    <div className='p-10 px-7 leading-none absolute '>
                    ...
                    <div className='flex  justify-center items-center gap-6  max-md:mt-5  md:absolute bottom-0 right-3  bg-white  rounded-[3rem]'>
                        <button className='py-8 px-[34px] max-md:w-full  justify-center rounded-[2.2rem] text-xl shadow-[inset_0_20px_70px_rgba(203,217,225,1)] hover:shadow-[inset_0_20px_70px_rgba(203,217,225,0.5)] flex  gap-2 items-center font-medium font-syne' onClick={() => handleBolkaSwarmSection()}>
